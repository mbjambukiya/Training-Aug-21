...
namespace Day3
{
    ...
    abstract class Employee : IEmp
    {
        ...
        public virtual void Get()
        {
            ...
            Console.WriteLine("Enter Employee Pan Card Number:");
    ...
    class Parttime : Employee
    {
        ...
        {
            base.Display();
            Console.WriteLine($"Employee Salry is {NoofHr * 25 + SaleperHr * 25}");
        }
    ...
    class Fulltime : Employee
    {
        ...
        {
            base.Display();
            Console.WriteLine($"Employee Salry is {Basic + Hra + Ta + Da}");
        }
