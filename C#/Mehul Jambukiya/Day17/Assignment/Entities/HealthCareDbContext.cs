...
namespace Day17_Assignment.Entities
{
    public partial class HealthCareDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public virtual DbSet<MadicineForPatient> MadicineForPatient { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MadicineForPatient>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("MadicineForPatient");
            ...
            modelBuilder.Entity<Patients>(entity =>
            {
                ...
                entity.HasIndex(e => e.ContactNo)
                    .HasName("UQ__Patients__5C667C05653A1DE0")
                    .IsUnique();
                ...
                entity.HasOne(d => d.CityNavigation)
                    ...
                    .HasConstraintName("FK__Patients__City__4AB81AF0");
            });
            ...
            modelBuilder.Entity<Treatment>(entity =>
            {
                ...
                entity.HasOne(d => d.AssistantNavigation)
                    ...
                    .HasForeignKey(d => d.Assistant)
                    .HasConstraintName("FK__Treatment__Assis__5812160E");

                entity.HasOne(d => d.DoctorNavigation)
                    .WithMany(p => p.Treatment)
                    .HasForeignKey(d => d.Doctor)
                    .HasConstraintName("FK__Treatment__Docto__5629CD9C");
