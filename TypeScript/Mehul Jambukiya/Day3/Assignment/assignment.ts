...
//   required to be generated for the use of HR group.

import * as interviewModule from "./interview";

console.log("\nRecruitment Portal - ABC Company")
...
switch (choice) {
    case 1:
        jobId = 1
        var department: interviewModule.Departments = interviewModule.Departments.Nodejs
